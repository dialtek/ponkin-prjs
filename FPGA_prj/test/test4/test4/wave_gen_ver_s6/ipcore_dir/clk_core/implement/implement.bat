...
xst -ifn xst.scr
copy clk_core_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clk_core.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_core.ucf clk_core_exdes

echo 'Running map'
map -timing -pr b clk_core_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm clk_core_exdes -w routed.ncd routed.v
cd ..
