...
/*=========================================================================== */
// KORAD controller USER functions 

void GPIO_init(void)
{
    // PORT B
    TRISBbits.TRISB14 = 0; // 4w to MOXA TX_EN
    TRISBbits.TRISB0 = 0;  // MODBUS_LED
    TRISBbits.TRISB1 = 0;  // RS232_LED
    TRISBbits.TRISB3 = 1;  // BTN_RESET
    TRISBbits.TRISB2 = 0;  // relay 1 LED
    TRISBbits.TRISB9 = 0;  // relay 2 LED
    ...
    TRISGbits.TRISG12 = 0;  // pol_realy 1
    TRISGbits.TRISG13 = 0;  // pol_realy 2
