...
#define U1BRGVAL (FP/(4*BAUDRATE))-1
 ...
 //input, respectively, overriding the TRIS and PORT register bit settings for the corresponding I/O port pins. 
    ...
    void Timer9_init(unsigned long baudrate)
    {
       ...
       switch(baudrate)
       {
           ...
           case 115200: PR9 = 8400; break; // 1 byte - 70 us, 3000 ~ 80 us, 2800 * 3 = 210 us
    ...
    {  
      ...
      //modbus_get_byte(U1RXREG);  // save rx byte into modbus rx buffer 
