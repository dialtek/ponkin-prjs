...
unsigned char rx_buf_ptr = 0; // указатель записи в массив UART
...
/* сброс modbus приемника */
  ...
  /* проверка состояния таймера целостности пакета */
  void check_timer_state(void)
  {

  }
  
  /* чтение 1 байта данных */
  void modbus_get_byte (unsigned char rx_byte) 
  {
	/// прием байта данных в буфер 
	rx_buf[rx_buf_ptr++] = rx_byte;
  }
  ...
  void modbus_wsr_answer() { 
    ...
    // расчет CRC
    crc_buf[0] = (rx_buf[0] == dev_id) ? dev_id : com_dev_id;
    ...
    TX_EN;
    uart_send_byte((rx_buf[0] == dev_id) ? dev_id : com_dev_id); // ID устройства
 ...
 // {
  ...
  {
//	TX_EN;
//	uart_send_byte(0x03); uart_send_byte(0x03); uart_send_byte(0x14);
//	uart_send_byte(0xaa); uart_send_byte(0xaa); uart_send_byte(0xaa); uart_send_byte(0xaa);
//	uart_send_byte(0x07); uart_send_byte(0xD0); uart_send_byte(0x00);
//	uart_send_byte(0x00); uart_send_byte(0x03); uart_send_byte(0xE8);
//	uart_send_byte(0x00); uart_send_byte(0x00); uart_send_byte(0x07);
//	uart_send_byte(0xd0); uart_send_byte(0x00); uart_send_byte(0x00);
//	uart_send_byte(0x03); uart_send_byte(0xe8); 
//	uart_send_byte(0x00); uart_send_byte(0x00); uart_send_byte(0xa7); uart_send_byte(0x26);
//	__delay_ms(1);
//	TX_DIS;
//	modbus_reset();  
	    
    if((rx_buf[0] == dev_id) || (rx_buf[0] == com_dev_id))     // state 3, ID check 
    {// ID OK
	    
	// rx_buf[1] = modbus cmd : 0x03 | 0x06 | 0x04
