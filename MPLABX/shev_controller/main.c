...
static void GPIO_init(void)              // MCU IO init
{
   ...
   //U2
   TRISBbits.TRISB12 = 1;   // U2RX, OVEN
   TRISFbits.TRISF12 = 0;   // U2TX, RP108, OVEN
   TRISFbits.TRISF13 = 0;   // U2/RS-485 TX EN
   
   //U3
   TRISBbits.TRISB14 = 1;   // U3RX, THYR
   TRISDbits.TRISD15 = 0;   // U3TX, THYR
   TRISBbits.TRISB15 = 0;   // U3/RS-485 TX EN
   ...
   // OVEN, UART2 peripheral pin select
   RPOR11bits.RP108R = 3;   // RF12 - U2TX, RP108
   RPINR19bits.U2RXR = 44;  // RB12 - U2RX, RPI44
   
   // THYR REG, UART3 peripheral pin select
   RPOR4bits.RP79R   = 0x1B;    // RD15 - U3TX, RP79
   RPINR27bits.U3RXR = 46;      // RB14 - U3RX, RPI44
