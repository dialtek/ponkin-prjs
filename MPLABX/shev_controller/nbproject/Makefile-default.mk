...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/shev_controller.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main_dosing_sys.c main_io.c d_delay.c d_eeprom.c d_one_wire.c d_SPI.c dialtek_modbus.c dialtek_uart.c hamilton_pump.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main_dosing_sys.o ${OBJECTDIR}/main_io.o ${OBJECTDIR}/d_delay.o ${OBJECTDIR}/d_eeprom.o ${OBJECTDIR}/d_one_wire.o ${OBJECTDIR}/d_SPI.o ${OBJECTDIR}/dialtek_modbus.o ${OBJECTDIR}/dialtek_uart.o ${OBJECTDIR}/hamilton_pump.o ${OBJECTDIR}/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main_dosing_sys.o.d ${OBJECTDIR}/main_io.o.d ${OBJECTDIR}/d_delay.o.d ${OBJECTDIR}/d_eeprom.o.d ${OBJECTDIR}/d_one_wire.o.d ${OBJECTDIR}/d_SPI.o.d ${OBJECTDIR}/dialtek_modbus.o.d ${OBJECTDIR}/dialtek_uart.o.d ${OBJECTDIR}/hamilton_pump.o.d ${OBJECTDIR}/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main_dosing_sys.o ${OBJECTDIR}/main_io.o ${OBJECTDIR}/d_delay.o ${OBJECTDIR}/d_eeprom.o ${OBJECTDIR}/d_one_wire.o ${OBJECTDIR}/d_SPI.o ${OBJECTDIR}/dialtek_modbus.o ${OBJECTDIR}/dialtek_uart.o ${OBJECTDIR}/hamilton_pump.o ${OBJECTDIR}/main.o

# Source Files
SOURCEFILES=main_dosing_sys.c main_io.c d_delay.c d_eeprom.c d_one_wire.c d_SPI.c dialtek_modbus.c dialtek_uart.c hamilton_pump.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/shev_controller.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/shev_controller.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/shev_controller.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG=__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)   -mreserve=data@0x1000:0x101B -mreserve=data@0x101C:0x101D -mreserve=data@0x101E:0x101F -mreserve=data@0x1020:0x1021 -mreserve=data@0x1022:0x1023 -mreserve=data@0x1024:0x1027 -mreserve=data@0x1028:0x104F   -Wl,--local-stack,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D__DEBUG=__DEBUG,--defsym=__MPLAB_DEBUGGER_ICD3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)  
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/shev_controller.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/shev_controller.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -Wl,--local-stack,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)  
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/shev_controller.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf   
