...
${OBJECTDIR}/_ext/1360937237/ADS1256.o: ../src/ADS1256.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1360937237" 
	@${RM} ${OBJECTDIR}/_ext/1360937237/ADS1256.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/ADS1256.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/ADS1256.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD4=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -DHAVE_CONFIG_H -DWOLFSSL_IGNORE_FILE_WARN -I"../src/config/pic32mz_ef_sk/library" -I"../src/config/pic32mz_ef_sk/library/tcpip/src" -I"../src/config/pic32mz_ef_sk/library/tcpip/src/common" -I"../src" -I"../src/config/pic32mz_ef_sk" -I"../src/packs/PIC32MZ2048EFM144_DFP" -I"../src/mips" -I"../src/third_party/wolfssl" -I"../src/third_party/wolfssl/wolfssl" -MMD -MF "${OBJECTDIR}/_ext/1360937237/ADS1256.o.d" -o ${OBJECTDIR}/_ext/1360937237/ADS1256.o ../src/ADS1256.c    -DXPRJ_pic32mz_ef_sk=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}
