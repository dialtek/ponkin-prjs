...
MENU_ADD(m_p0i2, m_p0i3, m_p0i1, m_p3i0, NULL,        NULL,      "    LED 6...7");
MENU_ADD(m_p0i3, m_null, m_p0i2, m_null, LED_Reset,   NULL,      "    Reset");
...
// Страница LED 6...7
MENU_ADD(m_p3i0, m_p3i1, m_null, m_null, LED_Handler, m_data[6], "    LED 6: %s");
MENU_ADD(m_p3i1, m_p3i2, m_p3i0, m_null, LED_Handler, m_data[7], "    LED 7: %s");
MENU_ADD(m_p3i2, m_null, m_p3i1, m_p0i2, NULL,        NULL,      "    Back");
...
void MENU_Init(void)
{
  ...
  // Цикл заполнения буфера исходными данными
