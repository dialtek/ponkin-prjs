...
{
	MDR_PORTE->OE			= 0xFF37; //0b1111111100110111;					// Bytes 7, 6, 3 are input
...
void Timer1_init(void)
{
	...
	MDR_RST_CLK->TIM_CLOCK |= 0x000; //0b000; 								// Frequency devider - 1:1
	MDR_TIMER1->CNTRL = 0x00000041;				 										// Mode is up and down
	MDR_TIMER1->PSG = 20;														  			// Frequency devider
	MDR_TIMER1->ARR = 8000;								 							  	  	// CNT + 1 = 1000
