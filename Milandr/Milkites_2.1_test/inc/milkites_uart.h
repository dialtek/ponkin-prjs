...
//MDR_UART2->FBRD = 26;   // дробная часть делителя скорости
  //Параметры делителя при частоте = 80000000Гц и скорости = 9600
  MDR_UART2->IBRD = 0x208; //целая часть делителя скорости
  MDR_UART2->FBRD = 0x35; //дробная часть делителя скорости
