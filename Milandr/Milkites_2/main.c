...
#define F_CPU 10000000 // HCLK frequency
#include "mdr_delay.h"
...
void OSC_init(void){
  ...
  MDR_RST_CLK->PLL_CONTROL = ((1 << 2) | (0 << 8)); 	  // вкл. PLL | коэф. умножения = 7
  									  // 7 при кварце 10 мег
  									  // 9 при кварце 8 мег
...
//#define S32 int32_t
//
//#define LCD_reset_ON	 MDR_PORTC->RXTX |=   1  
//#define LCD_reset_OFF 	 MDR_PORTC->RXTX &=  ~1
//#define LCD_A0_ON 	     MDR_PORTC->RXTX |=   (1<<1)  
//#define LCD_A0_OFF 	     MDR_PORTC->RXTX &=  ~(1<<1)
...
//
//#define LD4_ON  		 MDR_PORTB->RXTX |=   1<<2   
//#define LD4_OFF  		 MDR_PORTB->RXTX &= ~(1<<2)
//#define LD3_ON  		 MDR_PORTB->RXTX |=   1<<1   
//#define LD3_OFF  		 MDR_PORTB->RXTX &= ~(1<<1)
//#define LD2_ON  		 MDR_PORTB->RXTX |=   1   
//#define LD2_OFF  		 MDR_PORTB->RXTX &= ~1 
//
//#define SB1_ON  		 MDR_PORTB->RXTX == 800  // active low
//#define SB2_ON  		 MDR_PORTB->RXTX == 111
//#define SB4_ON  		 MDR_PORTB->RXTX == 1312
//#define SB5_ON  		 MDR_PORTD->RXTX == 3
// 
//
///*--------------------------------------------------------------------------- */
//// 1-wire
//#define One_wire_port_dir MDR_PORTB->OE
//#define One_wire_port 	  MDR_PORTB->RXTX
//#define One_wire_pin_num  0  // PD2
//
...
//    LCD_A0_OFF;
//	
//	for(U8 i = 0; i<21;i++) {SPI1_Wr_Data(INIT_LCD_TABLE[i]); delay_us(3);}
//	
//	}
//
...
//	delay_us(200);				  	    // разобраться с задержкой!!!
//										// ~ 200 мкс 
...
//  
//  if(!direction) One_wire_port_dir &= ~ 1; 			// пин PD2 на вход
//  else           One_wire_port_dir |= 1; 			// пин PD2 на выход
//  
//  MDR_PORTB->FUNC    = 0x0000;          // функция - порт 
//  MDR_PORTB->ANALOG  = 0xffff;          // режим потра - цифровой
//  MDR_PORTB->PWR     = 0xffffffff;      // максимально быстрый фронт ( порядка 10 нс)
...
// LD3_ON;
// 
// U8 sheak_head_coord_x = 58;
// U8 step = 1;
// U8 sheak_head_coord_y = 0;
// 
// U8 dir = 0; // напрвления движения змейки 	
// 
// U8 food_x_adr = rand() % 100;
// U8 food_y_adr = rand() % 7;
// 
// U8 snake_size = 4;
//
// //MDR_TIMER1->CNTRL = 1; // включить таймер 1
...
////	    dir = 3; 
////	 }
////	switch(porb_rxtx_val)
////	{
////  		case 864:  dir = 0; 		// двигаемся вправо
////			break;		
////   		case 1376: dir = 1; 		// двигаемся влево
////			break;
////		case 1632: dir = 2; 		// двигаемся вверх
////			break;
////	}
//	
//	
...
////	else
////	{			
////		dir = 3; 		// двигаемся вниз
////		LD3_ON;
////		delay_ms(20);		
////	}
//	
////	if(sheak_head_coord_x > 124)
////		{
////		  sheak_head_coord_x = 0;
////		}
////	if(sheak_head_coord_y > 7)
////		{
////		  sheak_head_coord_y = 7;
////		}
//
////			switch (dir)
////			{
////				case 0: sheak_head_coord_x += step; break;
////				case 1: sheak_head_coord_x -= step;	break;
////				case 2: sheak_head_coord_y -= 1; 	break;
////				case 3: sheak_head_coord_y += 1; 	break;
////			}
//			
//			//for(snake_size)
//			//{.
////			  	LCD_Clear();
////     			LCD_page_Adr_set(7);
////  				LCD_Column_Adr_set(sheak_head_coord_x);
////				
////				for(uint8_t i=0; i < 8; i++) {
////			  	// отрисовка змейки
////				  //if(dir > 1) { LCD_Wr_Data(head_ver[i]); }
////				  //else {LCD_Wr_Data(head_hor[i]);}
////				  LCD_Wr_Data(0xff);
////				  
////				}
////				
...
//			//}
//			
////			LCD_page_Adr_set(food_y_adr);
////  			LCD_Column_Adr_set(food_x_adr);
////			
////			for(uint8_t i=0; i<8; i++) {
////			  // отрисовка еды
////			  LCD_Wr_Data(0xaa);
////			}
//			
////			if ((dx >= food_x_adr) && (dy >= food_y_adr) )
////			{
////			 	food_x_adr = rand() % 100;
//// 				food_y_adr = rand() % 7;
////				
...
////			delay_ms(20); 
////			LCD_set_cursor(6);
////			LCD_Wr_num(MDR_PORTB->RXTX,5);
////			delay_ms(50);
////			LCD_Clear();
////			LCD_space(1);
////			LCD_Wr_num(food_y_adr,3);
////			  
////			LCD_set_cursor(5);
////			LCD_Wr_num(dx,3);
////			LCD_space(1);
