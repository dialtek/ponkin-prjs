...
namespace _701C_src_PGM
{
    ...
    public partial class Form1 : Form
    {
        ...
        const string ISOLATED_FILE_NAME = "HILAC_Dublets_cfq.txt";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            PGM_IP.Text = "D1.1 " + Src[0].IpAdress + "   " + "D1.2 " + Src[1].IpAdress + "   " +
                          "D2.1 " + Src[2].IpAdress + "   " + "D2.2 " + Src[3].IpAdress;
            NumberOfSources = 4;
