...
namespace _701C_src_PGM
{
    ...
    public partial class Form1 : Form
    {
        ...
        public static int NumberOfSources = 2; // переменная количества источников
        ...
        const string ISOLATED_FILE_NAME = "AxisSymLense_cfq.txt";
        ...
        private void U2setB_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                L1_hexValue = U2setInDEC_full.ToString("X4");
                IdAndV2set.Clear();

                IdAndV2set.Add(0, L1_hexValue);
        ...
        private void Update_timer_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (L1_SetVСmdStatus != "NoCmd")
                {
                    ...
                    {
                        case "-1": StatusBox.Text = "Ошибка соединения с источником L1"; break;
                        case "1": StatusBox.Text = "U = " + L1_U2setUpDown.Value.ToString() + " В на L1 установлено успешно"; break;
                        case "0": StatusBox.Text = "Ошибка установки напряжения на источнике L1"; break;
                    }
                ...
                if (L2_SetVСmdStatus != "NoCmd")
                {
                    ...
                    {
                        case "-1": StatusBox.Text = "Ошибка соединения с источником L2"; break;
                        case "1": StatusBox.Text = "U = " + L2_U2setUpDown.Value.ToString() + " В на L2 установлено успешно"; break;
                        case "0": StatusBox.Text = "Ошибка установки напряжения на источнике L2"; break;
                    }
        ...
        {
            U2setInDEC_full = Convert.ToUInt16(L1_U2setUpDown.Value);//Convert.ToUInt16(U2setVal.Text);
            L1_hexValue = U2setInDEC_full.ToString("X4");
        }
        ...
        {
            string ID = "1"; // № выбранного источника - L1
        ...
        private void Form1_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            writer.WriteLine(IP_1.Text); // 1 IP
            writer.WriteLine(IP_2.Text); // 1 IP
        ...
        private void LoadSettings()
        {
            ...
            IP_1.Text = settings[2];
            IP_2.Text = settings[3];
