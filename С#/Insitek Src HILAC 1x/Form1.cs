...
namespace Insitek_src
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Src[0].Interval = 1000;
            Src[0].IpAdress = "172.16.21.126";//"172.16.21.70";    //IPadrList[NumberOfSources];
        ...
        void ListView1_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            ...
            try
            {
                if (ListView1.SelectedIndices.Count > 0)
                {
                    ...
                    if (SrcModbusAddr == 30) IPV30_VoltUpDown.Maximum = 70;
                    else if (SrcModbusAddr == 40) IPV30_VoltUpDown.Maximum = 70;
                }
            }
            catch (Exception)
            {
