...
namespace _701C_src_PGM
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            PGM_IP.Text = "L1.1 " + Src[0].IpAdress + "   " + "L1.2 " + Src[1].IpAdress + "   " + "L1.3 " + Src[2].IpAdress;
            NumberOfSources = 3;
