...
namespace _701C_src_PGM
{
    ...
    public partial class Form1 : Form
    {
        ...
        const string ISOLATED_FILE_NAME = "L_2_cfq.txt";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            PGM_IP.Text = "L2.1 " + Src[0].IpAdress + "   " + "L2.2 " + Src[1].IpAdress + "   " + "L2.3 " + Src[2].IpAdress;
            NumberOfSources = 3;
