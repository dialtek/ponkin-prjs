...
namespace LU20_correctors_ctrl
{
    ...
    class ButtonSet: Control
    {
        public ButtonSet(Device device, string name, Thickness margin, string content, int width, int height)
        {
            pDevice = device;
            Name = name;
    ...
    {
        public TextBoxDevice(Device device, string name, Thickness margin, int width, int height, bool bold = false, int fonsize = 14, bool state = false)
        {
            ...
            device_grid.Name = name;
            device_grid.IsReadOnly = state;
            device_grid.VerticalAlignment = VerticalAlignment.Top;
            device_grid.HorizontalAlignment = HorizontalAlignment.Left;
            device_grid.TextAlignment = TextAlignment.Center;
            device_grid.FontSize = fonsize;
            device_grid.Background = new SolidColorBrush(Colors.OldLace);
            device_grid.Margin = margin;
            device_grid.Width = width;
            device_grid.Height = height;
    ...
    class intUpDownDevice : Control
    {
        public intUpDownDevice(Device device, string name, Thickness margin, int width, int height, bool bold = false, int max = 2600, int min = 0, int increment = 5)
        {
    ...
    class DoubleUpDownDevice : Control
    {
        public DoubleUpDownDevice(Device device, string name, Thickness margin, int width, int height, bool bold = false, int max = 2600, int min = 0, double increment = 0.1, int fontsize = 14)
        {

            pDevice = device;
            Name = name;
            
            var device_grid = new DoubleUpDown();           
            device_grid.Increment = 0.1;
            device_grid.UpdateValueOnEnterKey = true;
            device_grid.IsManipulationEnabled = true;
            device_grid.Name = name;
            device_grid.VerticalAlignment = VerticalAlignment.Top;
            device_grid.HorizontalAlignment = HorizontalAlignment.Left;
            device_grid.TextAlignment = TextAlignment.Center;
