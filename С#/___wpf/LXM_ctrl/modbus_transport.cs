...
namespace LXM_ctrl
{
    ...
    class modbus_transport
    {
        ...
        private event EventHandler<KeyValuePair<Dictionary<string, UInt16>, List<string>>> _RwComplete;
        ...
        /// </summary>
        public EventHandler<KeyValuePair<Dictionary<string, UInt16>, List<string>>> OnRwComplete
        {
                ...
                try
                {
                   ...
                   //     break;
                    ...
                    if (empty_queue_cbk_status == false)
                    {
                        ...
                        KeyValuePair<Dictionary<string, UInt16>, List<string>> device_response =     // ответ устройства
                                new KeyValuePair<Dictionary<string, UInt16>, List<string>>();
