...
namespace TCP_read
{
    ...
    public class EventDrivenTCPClient : IDisposable
    {
        ...
        public EventDrivenTCPClient(IPAddress ip, int port, bool autoreconnect = true)
        {
            ...
            this._client.NoDelay = false; //Disable the nagel algorithm for simplicity
        ...
        /// <summary>
        /// return the real connection status
        /// </summary>
        public bool ConnStatusReal
        {
            
            get 
            {
                return (bool)_client.Client.Connected;
            }
